...
<template>
    <Head title="Bem Vindo a Entrevista Onfly" />
    ...
    >
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="flex justify-center">
                <img width="156" height="48" src="https://www.onfly.com.br/wp-content/uploads/2021/10/onfly-footer.svg" class="image wp-image-3306  attachment-full size-full" alt="" decoding="async" style="max-width: 100%; height: auto;">
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    ...
                    >
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Controle de despesas</h2>

                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                Cadastre e edite suas despesas
                            </p>
                        </div>
